document.addEventListener('DOMContentLoaded', () => {
    ...
    function getPreferredLanguage() {
        return localStorage.getItem('preferredLanguage') === 'hi' ? 'hi' : 'en';
    }
...
function initTranslateControl() {
    ...
    const activeLanguage = languages[savedLanguage] ? savedLanguage : 'en';
    ...
    function setTranslateCookie(value) {
        ...
        // Always set the host-level cookie (no domain attribute) - works universally
        document.cookie = `googtrans=${value}; path=/; max-age=${maxAge}; SameSite=Lax`;

        // If not local, also set with domain parameters to support subdomains
    ...
    function clearTranslateCookie() {
        ...
        // Clear domain cookies on current host and parent domains to clean up legacy duplicates
